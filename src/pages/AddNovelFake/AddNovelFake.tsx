...
export default function AddNovelFake() {
        ...
        variables: {
          input: {
            ...
            first_novel_publish_at:
              formData.first_novel_publish_at.toISOString(),
          },
        },
        refetchQueries: [
          { query: GET_NOVELS, variables: { page: 1, limit: 2 } },
        ],
      });
        ...
        updateQuery: (prev, { fetchMoreResult }) => {
          ...
          return {
            ...
            novels: {
              ...
              novels: [...prev.novels.novels, ...fetchMoreResult.novels.novels],
            },
          };
        },
      });
      ...
      <div className="content flex-1 ">
        <div className="mx-auto max-w-3xl p-4">
          <form onSubmit={handleSubmit} className="form-control w-full">
            ...
            <MyDatePicker
              selectedDate={formData.first_novel_publish_at}
          ...
          {loading ? (
            ...
            <div className="mt-[50px] flex flex-wrap gap-2">
              {data.novels.novels.map((novel) => (
                <div
                  key={novel.novel_id}
                  className="card bg-base-100 w-[360px] shadow-xl"
                >
                  <div className="card-body">
                    <h2 className="card-title">{novel.title}</h2>
                    <p>
                      {formatDate(
                        novel.first_novel_publish_at,
          ...
          {data &&
            data.novels.novel_pagination.currentPage <
              data.novels.novel_pagination.totalPages && (
