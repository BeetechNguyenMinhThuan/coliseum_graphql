...
export type Novel = {
  ...
  total_badges?: Maybe<Scalars['Int']['output']>;
  total_bookmarks?: Maybe<Scalars['Int']['output']>;
  total_likes?: Maybe<Scalars['Int']['output']>;
  updated_at?: Maybe<Scalars['DateTime']['output']>;
  user?: Maybe<User>;
...
export type QueryGetDetailUserArgs = {
...
export type GetNovelsPaginateQuery = { __typename?: 'Query', getNovelsPaginate?: { __typename?: 'NovelPagination', totalItems?: number | null, totalPages?: number | null, currentPage?: number | null, novels?: Array<{ __typename?: 'Novel', novel_id?: number | null, novel_ulid?: string | null, user_id?: number | null, title?: string | null, synopsis?: string | null, cover_picture_url?: string | null, foreword_url?: string | null, afterword_url?: string | null, setting_url?: string | null, note_url?: string | null, dictionary_url?: string | null, is_anonymous?: boolean | null, is_publish?: boolean | null, is_ranking_visible?: boolean | null, is_completed?: boolean | null, is_comment?: boolean | null, is_comment_publish?: boolean | null, first_novel_publish_at?: any | null, first_name_publish_at?: any | null, first_completed_at?: any | null, total_likes?: number | null, total_badges?: number | null, total_bookmarks?: number | null, created_at?: any | null, updated_at?: any | null, deleted_at?: any | null, user?: { __typename?: 'User', name: string } | null, novel_tag?: Array<{ __typename?: 'OfficialTag', tag?: string | null } | null> | null, novel_badges?: Array<{ __typename?: 'OfficialBadge', badges_name?: string | null } | null> | null, novel_comments?: Array<{ __typename?: 'NovelComment', comment?: string | null } | null> | null }> | null } | null };
...
export type GetUsersBaseQuery = { __typename?: 'Query', getUsers?: Array<{ __typename?: 'User', user_id: string, user_uuid: string, name: string, s3_url: string, first_login_at: any, last_login_at: any, created_at?: any | null, updated_at?: any | null, deleted_at?: any | null } | null> | null };

export type GetDetailUserQueryVariables = Exact<{
  user_id?: InputMaybe<Scalars['ID']['input']>;
}>;


export type GetDetailUserQuery = { __typename?: 'Query', getDetailUser?: { __typename?: 'User', user_id: string, user_uuid: string, name: string, s3_url: string, first_login_at: any, last_login_at: any, created_at?: any | null, updated_at?: any | null, deleted_at?: any | null, isSpaceShipPassenger?: boolean | null } | null };
...
export const GetDetailUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetDetailUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getDetailUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"user_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"user_uuid"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"s3_url"}},{"kind":"Field","name":{"kind":"Name","value":"first_login_at"}},{"kind":"Field","name":{"kind":"Name","value":"last_login_at"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"deleted_at"}},{"kind":"Field","name":{"kind":"Name","value":"isSpaceShipPassenger"}}]}}]}}]} as unknown as DocumentNode<GetDetailUserQuery, GetDetailUserQueryVariables>;